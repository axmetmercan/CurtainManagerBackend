...
class Picture(models.Model):
    ...
    uploaded_by = models.ForeignKey('company.Company', null=False, blank=False, default=1, on_delete=models.CASCADE, related_name='uploaded_by', verbose_name='Yükleyici',)
