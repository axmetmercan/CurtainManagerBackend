...
class BrandsListView(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        ...
        for whole_saler in whole_salers:
            ...
            brands_of_whole_saler = Brand.objects.filter(
                owner=whole_saler.whole_saler)
    ...
    def perform_create(self, serializer):
        ...
        instance = serializer.save(
            ...
            owner=Company.objects.get(id=current_company)
        )
...
class MyBrandList(viewsets.GenericViewSet, mixins.ListModelMixin):
    serializer_class = BrandSerializer
    permission_classes = [permissions.IsAuthenticated]
    pagination_class = DefaultPagination
    ...
    def get_queryset(self):
        ...
        current_company = self.request.user.company
        q = Brand.objects.filter(owner=current_company)
