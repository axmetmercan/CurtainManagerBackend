...
class CustomerOrder(models.Model):
    ...
    measurement = models.ForeignKey(Measurement, on_delete=models.CASCADE, verbose_name='Ölçüler', related_name='measurements' ,blank=False, null=False)
    measurement_group = models.ForeignKey(MeasurementGroup, on_delete=models.CASCADE, verbose_name='Ölçü Grubu', related_name='measurement_groups', null=False, blank=False)
    customer = models.ForeignKey(Customer, on_delete=models.SET_NULL, related_name='customers', verbose_name='Müşteri', default=1, null=True, blank=False)
